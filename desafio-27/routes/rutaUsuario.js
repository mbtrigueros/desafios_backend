...
usuarioRouter.get('/auth/facebook', passport.authenticate('facebook', { scope: ["email"] }));
usuarioRouter.get('/auth/facebook/datos', passport.authenticate('facebook', { failureRedirect: '/usuario/failedLogin' }),
    function (req, res) {
        const data = req.session.passport;
        console.log(data)
  
        res.render('./layouts/websocket.hbs', { data });
});
