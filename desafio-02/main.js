...
function operaciones() {
    operacion(20, 5, 'suma').then(function (resultado) { return console.log('El resultado de tu operacion es: ', resultado); });
    operacion(20, 5, 'resta').then(function (resultado) { return console.log('El resultado de tu operacion es: ', resultado); });
}
operaciones();
